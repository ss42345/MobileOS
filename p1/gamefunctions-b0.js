...
//-------------------------------------------------------------
    ...
    function SetupMenu() {
        ...
        divUserName.style.width = Math.round(WinWidth*(x1-x0))+'px';
    ...
    function HandleOrientation(event) {
        ...
        var divTime = document.getElementById('divTime');
        divTime.innerHTML = 'Time  ' + minutes + ':'+ (seconds <= 9 ? '0'+seconds:seconds);
        ...
        if (goalReached) {
            ...
            //alert('Level = ' + Game.Level + ' Numlevels = ' + Game.NumLevels);
            if (Game.Level >= Game.NumLevels) {
                EndGame();
                return;
            }
